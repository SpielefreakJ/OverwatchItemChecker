...
namespace OverwatchLootBoxTracker.Languages.German.Heroes
{
    class Ana
    {
        ...
        public Ana()
        {
            ...
            Turquoise_SK = "TÜRKIS";
            //Epic
            Merciful_SK = "SCHUTZENGEL";
            Shrike_SK = "SHRIKE";
            Ghoul_SK = "GHUL";//Halloween 16
            ...
            Horus_SK = "HORUS";
            Corsair_SK = "KORSARIN";//Halloween 17
            Snow_Owl_SK = "SCHNEEEULE";//Winter 17
            #endregion
            #region Emotes
            //Epic
            Disapproving_EM = "MISSBILLIGEND";
            Not_Impressed_EM = "UNBEEINDRUcKT";
            Protector_EM = "BESCHÜTZERIN";
            Take_A_Knee_EM = "KNIEND";
            Tea_Time_EM = "TEA TIME";
            Beach_Ball_EM = "WASSERBALL";//Summer 17
            Candy_EM = "SÜSSIGKEITEN";//Halloween 16
            Dance_EM = "TANZEN"; ;//Annyver 17
            #endregion
            #region Victory Poses
            //Rare
            Mission_Complete_VP = "MISSION ERFOLGREICH";
            Protector_VP = "BESCHÜTZEND";
            Seated_VP = "SITZEND";
            RIP_VP = "R.I.P.";//Halloween 16
            Toast_VP = "PROST";//Winter 16
            Folded_Hands_VP = "GEFALTETE HÄNDE";//Rooster 17
            #endregion
