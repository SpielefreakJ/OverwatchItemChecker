...
namespace OverwatchLootBoxTracker.Languages.English.Heroes
{
    class EN_Junkrat
    {
        public EN_Junkrat()
        {
            ...
            #region Skin
            //Rare
            Bleached_SK = "Bleached";
            Drowned_SK = "Drowned";
            Irradiated_SK = "Irradiated";
            Rusted_SK = "Rusted";
            //Epic
            Jailbird_SK = "Jailbird";
            Toasted_SK = "Toasted";
            Firework_SK = "Firework";//Rooster 17
                                     //Legendary
            Fool_SK = "Fool";
            Jester_SK = "Jester";
            Hayseed_SK = "Hayseed";
            Scarecrow_SK = "Scarecrow";
            ...
            #region Emotes
            //Epic
            Cant_Deal_EM = "Can't Deal";
            Juggling_EM = "Juggling";
            Lounging_EM = "Lounging";
            Puppet_EM = "Puppet";
            Vaudeville_EM = "Vaudeville";
            Dud_EM = "Dud?";//Rooster 17
            Running_Rat_EM = "Running Rat";//Annyver 17
            #endregion
            #region Victory Poses
            //Rare
            Itll_freeze_that_way_VP = "It'll freeze that way";
            Kneeling_VP = "Kneeling";
            Nyah_Nyah_VP = "Nyah Nyah";
            Medal_VP = "Medal";//Summer 17
            Pumpkin_VP = "Pumpkin";//Halloween 17
            RIP_VP = "R.I.P.";//Halloween 16
            Bad_for_your_health_VP = "Bad for your health";//Rooster 17
            #endregion
            #region Voice Lines
            //Common
        ...
        public string Jailbird_SK { get; }//Epic
