...
namespace OverwatchLootBoxTracker.Languages.English.Heroes
{
    class DVa
    {
        public DVa()
        {
            ...
            #region Skin
            //Rare
            Blueberry_SK = "Blueberry";
            Lemon_Lime_SK = "Lemon-Lime";
            Tangerine_SK = "Tangerine";
            Watermelon_SK = "Watermelon";
            //Epic
            Carbon_Fiber_SK = "Carbon Fiber";
            White_Rabbit_SK = "White Rabbit";
            Taegeukgi_SK = "Taegeukgi";//Summer 16
            //Legendary
            Junker_SK = "Junker";
            Scavenger_SK = "Scavenger";
            BVa_SK = "B.Va";
            Junebug_SK = "Junebug";
            Black_Cat_SK = "BLACK CAT";
            Officer_SK = "Officer";
            Waveracer_SK = "WAVERACER";//Summer 18
            Palanquin_SK = "Palanquin";//Rooster 17
            Cruiser_SK = "Cruiser";//Annyver 17
            #endregion
            #region Emotes
            //Epic
            _O__EM = "^O^";
            Bunny_Hop_EM = "Bunny Hop";
            Heartbreaker_EM = "Heartbreaker";
            Party_Time_EM = "Party Time";
            Bow_EM = "Bow";//Rooster 17
            ...
            //Rare
            I_Heart_You_VP = "I Heart You";
            Peace_VP = "Peace";
            Sitting_VP = "Sitting";
            RIP_VP = "R.I.P.";//Halloween 16
            Festive_VP = "Festive";//Winter 16
            Lucky_Pouch_VP = "Lucky Pouch";//Rooster 17
            #endregion
            #region Voice Lines
            //Common
