...
namespace OverwatchLootBoxTracker.Languages.English.Heroes
{
    class EN_Hanzo
    {
        public EN_Hanzo()
        {
            ...
            Cloud_SK = "Cloud";
            Dragon_SK = "Dragon";
            Demon_SK = "Demon";//Halloween 16
            //Legendary
            Young_Hanzo_SK = "Young Hanzo";
            Young_Master_SK = "Young Master";
            Lone_Wolf_SK = "Lone Wolf";
            Okami_SK = "Okami";
            Casual_SK = "Casual";//Winter 17
            Cyberninja_SK = "Cyberninja";//Annyver 17
            #endregion
            #region Emotes
            //Epic
            Beckon_EM = "Beckon";
            Brush_Shoulder_EM = "Brush Shoulder";
            Chuckle_EM = "Chuckle";
            Meditate_EM = "Meditate";
            Victory_EM = "Victory";
            Training_EM = "Training";//Uprising 17
            Fisherman_Dance_EM = "Fisherman Dance";//Annyver 17
            #endregion
            ...
            Skewered_VP = "Skewered";//Halloween 17
            #endregion
            #region Voice Lines
            //Common
        ...
        public string Young_Hanzo_SK { get; }//Legendary
